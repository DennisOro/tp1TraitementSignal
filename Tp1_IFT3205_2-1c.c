...
int  power(int, int);
void Amplifier(float** Img, int length, int width);
...
int main(int argc,char **argv)
 {
  ...
  /*Amplifier avec distance euclidienne*/
  Amplifier(MatriceImgR,length,width);
  Amplifier(MatriceImgI,length,width);
